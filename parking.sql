...
MySQL - 5.6.47-log : Database - parking
*********************************************************************
*/
...
DROP TABLE IF EXISTS `parking_category`;

CREATE TABLE `parking_category` (
  `category_id` int(11) NOT NULL AUTO_INCREMENT,
  `category_name` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `category_added_on` int(16) NOT NULL,
  `category_updated_on` int(16) NOT NULL,
  PRIMARY KEY (`category_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `parking_category` */
...
CREATE TABLE `parking_customer` (
  ...
  `customer_contact_no` varchar(12) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `vehicle_status` enum('In','Out') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
/*Data for the table `parking_customer` */
...
DROP TABLE IF EXISTS `parking_duration`;
...
/*Data for the table `parking_duration` */
...
/*Data for the table `parking_price` */
...
DROP TABLE IF EXISTS `parking_setting`;

CREATE TABLE `parking_setting` (
  `parking_id` int(11) NOT NULL AUTO_INCREMENT,
  `parking_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parking_contact_person` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parking_contact_number` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parking_timezone` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parking_currency` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parking_datetime_format` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parking_created_on` int(16) NOT NULL,
  `parking_updated_on` int(16) NOT NULL,
  PRIMARY KEY (`parking_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `parking_setting` */
...
CREATE TABLE `parking_slot` (
  ...
  `parking_slot_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parking_slot_status` enum('Available','Not Available') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `parking_user` (
  ...
  `user_email_address` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
/*Data for the table `parking_user` */
